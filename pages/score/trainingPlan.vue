<template>
	<view>
		...
		<template v-else>
			<view class="margin" v-if="plan && plan.courseList && plan.courseList.content">
				<button @click="exportPlan" class="cu-btn bg-gradual-blue round"><text class="cuIcon-down"></text>下载</button>
			</view>
			<view class="bg-white margin padding card-radius padding-bottom-xl">
