<template>
	<view class="bg-white margin card-radius padding-lr-xs padding-tb" v-if="data">
		...
		<view class="flex margin-top-sm text-bold bg-blue light text-center">
			<view class="text-center border text-black" style="width: 415rpx;">
				<text>{{data.headTitle[0]}}</text>
			</view>
			<view class="value-cell border text-black">{{data.headTitle[1]}}</view>
			<view class="value-cell border text-black">{{data.headTitle[2]}}</view>
		</view>
		...
		<view class="bg-blue light padding-tb-xs">
